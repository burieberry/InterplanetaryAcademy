...
const seed = () => {
  return Promise.all([
    ...
    Campus.create({ name: 'Parblesnops', image: 'https://vignette.wikia.nocookie.net/rickandmorty/images/1/1d/Screenshot_2016-01-18_at_6.00.19_PM.png/revision/latest?cb=20160118231955' })
  ])
